...
c.url.default_page = 'https://americasdecline.neocities.org/main'
c.url.start_pages = 'https://americasdecline.neocities.org/main'
...
config.bind(',dr', 'config-cycle content.user_stylesheets ~/.config/qutebrowser/darculized/darculized-all-sites.css ""')
...
config.bind(',sd', 'config-cycle content.user_stylesheets ~/.config/qutebrowser/solarized-dark-all-sites.css ""')
